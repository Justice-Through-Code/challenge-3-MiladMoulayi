...
#   TODO: Explain how d is set to False in a comment
    # Change or operator to and operator. Because not (8 < 20) == false, and (5 < 7) == true, they cannot both be true. The and operator sets a boolean value to false if both conditions are not met.
